...
const SETTINGS_CONFIG = {
    ...
    Project2: {
        ...
        extended_description_fr: "Détails de la méthodologie agile appliquée : Utilisation de Scrum avec sprints de 4h, stand-up meetings quotidiens et rétrospectives. Mise en place d'un board Kanban physique comme radiateur d'information. Architecture Java avec pattern MVC, interface graphique JavaFX et base de données H2 embarquée. Gestion des événements avec design pattern Observer pour les interactions joueur-plateau. Tests unitaires JUnit et intégration Maven pour la gestion des dépendances. Documentation technique générée avec Javadoc.",
    ...
    Project4: {
        ...
        extended_description_fr: "Architecture Flutter avec pattern BLoC pour la gestion d'état, intégration Firebase pour l'authentification et la base de données temps réel. Système de paiement sécurisé via Stripe API avec validation côté serveur. Cache local SQLite pour le mode offline avec synchronisation automatique. Notifications push Firebase Cloud Messaging avec segmentation utilisateur. Animations Flutter avancées avec Hero widgets et transitions personnalisées. Tests d'intégration automatisés et déploiement sur stores.",
