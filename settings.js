...
const SETTINGS_CONFIG = {
    ...
    UI: {
        ...
        about_description_en: "<p>Passionate Computer Science student, I'm particularly interested in application design, optimization, automation and deployment. Having started developing at a young age, my experience gives me perspective on IT project management; reliability, maintainability and compliance are my watchwords. I also place great importance on communication, whether it's exchanges with my team or collaboration with the end client.</p><p>On a more personal level, I'm a simple and sociable person, always focused on the positive. I particularly enjoy geography, swimming and football. My core values: gratitude, punctuality and respect.</p><p>Discover my vision of computer science through my projects presented on this page — perhaps I'm even developing a new one right now!</p><p><strong>I'm also looking for an internship for April 2026 (10 weeks duration). Contact me if you think we can move forward together!</strong></p>",
        about_years_value: "5+",
        ...
        philosophy_opt_desc_en: "I continuously optimize my development approach and now integrate LLM agents into my workflow to increase productivity. I use Claude Code and Codex (GPT-5) in a complementary way, while remaining vigilant about data and result validation. These tools represent promising technologies to adopt with rigor.",
    ...
    Project1: {
        ...
        extended_description_fr: "Architecture technique avancée : Le projet utilise ttkbootstrap pour l'interface graphique native, avec un système de plugins modulaire permettant l'extension des fonctionnalités. L'intégration avec Gemini API se fait via requêtes asynchrones pour maintenir la fluidité de l'interface. Le système de prévisualisation PDF utilise une compilation LaTeX dans la RAM en temps réel (synctex) avec gestion d'erreurs intelligente. Gestion et configuration des réponses IA ; Schéma JSON pour la relecture (force un retour JSON traitable), température et top_k adaptés à chaque tâche. Système de templates personnalisables et raccourcis clavier configurables pour optimiser la productivité.",
    ...
    Project3: {
        ...
        description_fr: "Je classifie ce site en projet personnel car j'y ai consacré beaucoup de temps ! En informatique, j'ai toujours pensé que la démonstration est quelque chose de très important. Le savoir-faire n'est rien sans le faire-savoir et je fais toujours attention à présenter une image et un langage impeccable à toute réalisation. Mon objectif était donc de créer un portfolio partageable, clair et concis, mettant en valeur mes compétences et projets, afin qu'ils soient mis en lumière ; lumière alors universelle, s'adressant autant à des personnes familières à l'informatique qu'à des novices.",
