...
class ConfigLoader {
    ...
    generateSkillsBadges() {
        ...
        const skillIcons = {
            ...
            'Jakarta EE': 'https://img.icons8.com/color/48/java-coffee-cup-logo--v1.png',
            'JavaFX': 'https://img.icons8.com/color/48/java-coffee-cup-logo--v1.png',
            'C': 'https://img.icons8.com/color/48/c-programming.png',
            'AHK': 'https://img.icons8.com/color/48/automation.png',
